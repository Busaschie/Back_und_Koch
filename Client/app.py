...
if "selected_date" not in st.session_state:
    st.session_state.selected_date = "2026-07-13"
...
def get_api_one_task(shop_date: str):
    try:
        ...
        erwartete_spalten = ['monat', 'jahr', 'shop_date', 'abgabe_date', 'geld_date']
...
with col_rechts:
    with st.container(border=True):
        ...
        with st.expander("Schritt 2: Sammelbuchung"):
            ...
            st.link_button("Speichern", "http://localhost:8501/app.py")
